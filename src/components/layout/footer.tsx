...
const socialLinks = [
  ...
  { name: "WhatsApp", icon: <WhatsAppIcon className="w-8 h-8" />, href: "https://wa.me/27641663906" },
];
          ...
          <div className="flex flex-col items-center md:items-end">
            ...
            <div className="flex space-x-4">
              {socialLinks.map((link) => (
                <Link key={link.href} href={link.href} className="text-muted-foreground hover:text-primary transition-colors" target="_blank" rel="noopener noreferrer">
